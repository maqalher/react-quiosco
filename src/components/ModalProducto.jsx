...
const ModalProducto = () => {
    ...
    // cada vez que pedido cambie se vuelve a ejecutar
    useEffect( () => {
    ...
    return (
        <div className="md:flex items-center gap-10">
            ...
            <div className="md:w-2/3">
                ...
                <p className="mt-5 font-black text-5xl text-amber-500">{fomatearDinero(producto.precio)}</p>
                ...
                <div className="flex gap-4 mt-5 mb-3">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    </button>
                ...
                >   {edicion ? 'Guarar Cambios' : 'Añadir al Pedido'}
